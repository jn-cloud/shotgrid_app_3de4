...
class Tde4RenderPublishPlugin(HookBaseClass):
    """
    ...
    def validate(self, settings, item):
        ...
        return super(Tde4RenderPublishPlugin, self).validate(settings, item)
    ...
    def create_settings_widget(self, parent):
        ...
        :return: A QtGui.QWidget or subclass that displays information about
            ...
            settings.
        """
        description_widget = super(Tde4RenderPublishPlugin, self).create_settings_widget(None)
